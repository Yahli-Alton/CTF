...
MASTER_KEY = b"*\xe1\xe2\xdfG\xc3k\x02\xee}|\xe2\x99l\x04\xa4"

def generate(username):
    # iv = secrets.token_bytes(16)
    iv = b'k\xc5z\x93f\xf2\xdf18\x95\xcd\x81\xec4\xae['
...
def verify(token):
    ...
    print("received:", pt, file=sys.stderr)

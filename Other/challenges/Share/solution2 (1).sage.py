...
# This file was *autogenerated* from the file solution2.sage
...
def main():
  ...
  _sage_const_431 ]
    ...
    requests = _sage_const_0 

    for j, prime in enumerate(primes):
        possibilities = set(range(prime))

        v = vector(GF(prime), [_sage_const_1 ] * (prime - _sage_const_2 ))
        v = inverses[j] * v

        while len(possibilities) != _sage_const_1 :
            requests += _sage_const_1 
            print(requests)
            ...
            for i in range(prime - _sage_const_2 ):
                possibilities.discard(mod_division(shares[i] + _sage_const_1 , v[i], prime))

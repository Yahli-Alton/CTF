...
def substitution(ptext): ##DONE
    pattern = [37, 2, 8, 14, 16, 26, 47, None, 1, 12, 0, 25, 4, 3, 10, None, 21, 45, 32, 35, 
15, 44, 40, None, 9, 27, 34, 31, 29, 46, 18, None, 43, 41, 17, 36, 42, 23, 28, None, 24, 13, 19, 5, 22, 20, 7, None] #Redacted
    scrambled = ''
    for i in pattern:
        if i is None:
            scrambled += "0"
